        ...
        <TabContext value={value}>
          ...
          <TabPanel value="1">
            <Typography variant="body1" gutterBottom>
              ...
              current centralized blogging platforms have several disadvantages that limit the creativity and freedom of
              expression of both authors and readers.
            </Typography>
            <Typography variant="body1" gutterBottom>
              Centralized blogs are controlled by a central authority that decides what content can be published and who
              can access it. This leads to issues such as censorship, where certain ideas and opinions may be silenced
              or removed from the platform. It also limits the ability of authors to monetize their content, as the
              platform owner often takes a large percentage of the revenue generated from the content.
            </Typography>
            <Typography variant="body1" gutterBottom>
              In contrast, our platform is decentralized and powered by blockchain technology. This means that there is
              no central authority controlling the platform, and users have complete control over their content and
            ...
            <ol>
              ...
              <li>
                Ownership and control of content: Fair Journal is designed to give users complete ownership and control
                over their content. This means that authors can decide how their content is published, shared, and
                distributed, and they can choose whether or not to monetize their content.
              </li>
              <li>
                Fair compensation for creators: Through features such as donations and NFT purchases, users can support
                the creators they love and help them earn a living from their work. This provides authors with a fair
                and transparent way to monetize their content without relying on a centralized platform owner.
              </li>
              <li>
                Privacy and security: With Fair Journal, users have complete control over their data and can decide how
                it is used and who has access to it. This provides users with greater privacy and security compared to
                centralized blogging platforms, which may be vulnerable to data breaches and hacking attempts.
              </li>
            </ol>
            <Typography variant="body1" gutterBottom>
          ...
          <TabPanel value="2">
            ...
            <ul>
              ...
              <li>Build a strong and vibrant community of users who support each other and promote free expression</li>
            </ul>
          ...
          <TabPanel value="3">
            <ul>
              <li>
                ...
                signing articles using it to confirm authorship. Finally, the milestone will include the implementation
                of blog creation and management.
              </li>
              <li>
